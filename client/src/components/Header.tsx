          ...
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center space-x-12">
              <a 
                ...
                style={{ 
                  color: currentPage === 'home' ? 'var(--primary-color)' : 'var(--navigation-color)',
              ...
              <a 
                ...
                className="text-sm uppercase tracking-wide transition-colors hover:opacity-70"
                style={{ 
                  color: currentPage === 'properties' ? 'var(--primary-color)' : 'var(--navigation-color)',
                  fontWeight: currentPage === 'properties' ? 'bold' : 'normal'
                }}
              >
                Properties
              </a>
              <a 
                ...
                className="text-sm uppercase tracking-wide transition-colors hover:opacity-70"
                style={{ 
                  color: currentPage === 'agent' ? 'var(--primary-color)' : 'var(--navigation-color)',
                  fontWeight: currentPage === 'agent' ? 'bold' : 'normal'
                }}
              >
                Agent
              </a>
